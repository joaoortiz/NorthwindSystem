...
<div class="row" style="margin-top: 20px;">
    ...
    <div class="col-lg-10">
        <div class="row">
            <div class="col-lg-12">
                <a href="?idPg=11&idReg=<?=$tblCliente['CustomerID'];?>">
...
<?= $idVenda ?>
    ...
    <div class="col-lg-2 "><?= corrigirData($tblVenda['OrderDate']) ?></div>
    <div class="col-lg-2 "><?= corrigirData($tblVenda['ShippedDate']) ?></div>
    <div class="col-lg-2 ">U$ <?= number_format(calcularCompra($vConn, $tblVenda['OrderID']), 2) ?></div>
    <div class="col-lg-1 ">U$ <?= number_format($tblVenda['Freight'], 2) ?></div>
