...
$sqlVenda = "Insert into orders(customerid, employeeId, orderdate, requireddate, shippeddate, shipvia, freight, active) values (";
$sqlVenda.= "'$idCli',$idFunc,'$dataPed','$dataPag', '$dataEnvio', $idTrans, $frete,1)";
