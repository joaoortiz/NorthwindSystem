...
<form action="RegistraVenda.php" method="post">
    ...
    <div class="row LinhaForm">
        ...
        <div class="col-lg-4">
            <label>Frete: </label>
            <input type="text" name="HTML_frete" class="form-control">
        </div>
    ...
    <div class="row">
        <div class="col-lg-4 border-right">
            <div class="row LinhaForm">
                ...
                ?>
                <option value="<?=$tblProd[0];?>"><?=$tblProd[0]?> - <?=$tblProd[1];?> (<?=number_format($tblProd[5],2);?>) </option>
        ...
        <div class="col-lg-8" style="padding-top:15px;">
            ...
            ?>
                    <tr>
                        ...
                        <td width="15%"><?=number_format($tblItem['UnitPrice'] * $qProd,2);?></td>
                        
                        <?php
                        $valorPed+=$tblItem['UnitPrice'] * $qProd;
                        ?>
                    </tr>
            ...
            <hr>
            <div class="float-right"><h4>Total: <?=number_format($valorPed,2);?></h4></div>
